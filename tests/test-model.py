...
for i in range(10):
    ...
    test_result = fOBJ(x, 1.0,I,K,al,l,YGROSS,sigma,EIND,E,CCA,CCATOT,cumetree,MAT,MU,ML,FORC,TATM,TOCEAN,DAMFRAC,DAMAGES,ABATECOST,cost1,MCABATE,CPRICE,YNET,Y,C,CPC,PERIODU,CEMUTOTPER,RI,NT)
    ...
    for i in range(99):
        state,reward,done,_ = env.step(np.array([renormed_action, renormed_action]))
